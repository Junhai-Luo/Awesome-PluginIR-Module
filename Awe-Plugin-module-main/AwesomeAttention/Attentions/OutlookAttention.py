...
class OutlookAttention(nn.Module):
    def __init__(self, dim, num_heads=1, kernel_size=3, padding=1, stride=1, qkv_bias=False,
        ...
        self.v_pj = nn.Linear(dim, dim, bias=qkv_bias)  # 特征映射
        self.attn = nn.Linear(dim, kernel_size**4 * num_heads)  # 注意力映射
        ...
        self.pool = nn.AvgPool2d(kernel_size=stride, stride=stride, ceil_mode=True)  # 平均池化
