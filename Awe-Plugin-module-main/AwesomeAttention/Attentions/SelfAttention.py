...
class ScaledDotProductAttention(nn.Module):
    ...
    def __init__(self, d_model, d_k, d_v, h, dropout=.1):
        '''
        初始化函数，接收模型的输出维度d_model、查询和键的维度d_k、值的维度d_v、注意力头的数量h以及dropout率
...
if __name__ == '__main__':
    ...
    sa = ScaledDotProductAttention(d_model=512, d_k=64, d_v=64, h=8)  # 创建注意力机制实例，注意d_k和d_v应小于d_model
